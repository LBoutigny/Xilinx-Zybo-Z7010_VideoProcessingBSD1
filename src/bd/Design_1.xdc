...
##Clock signal
##IO_L11P_T1_SRCC_35
set_property PACKAGE_PIN L16 [get_ports ClkSys]
set_property IOSTANDARD LVCMOS33 [get_ports ClkSys]
create_clock -period 8.000 -name sys_clk_pin -waveform {0.000 4.000} -add [get_ports ClkSys]
